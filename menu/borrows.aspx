...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div class="inf">
     ...
     <div class="btn">
         ...
         <asp:Button ID="Button2" runat="server" CssClass="txtBtn" Text="TraSach" ValidationGroup="ffValidation" OnClick="Button2_Clickn" />
         <asp:Button ID="Button3" runat="server" CssClass="txtBtn" Text="GiaHan" ValidationGroup="foValidation" OnClick="Button3_Click" />
         <asp:Button ID="Button4" runat="server" CssClass="txtBtn" Text="Xoa" ValidationGroup="flValidation" OnClick="Button4_Click" />
     </div>
 </div>
    <%-- popUp form --%>
